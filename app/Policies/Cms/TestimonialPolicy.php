...
class TestimonialPolicy
{
    ...
    {
        if ($user->hasPermissionTo(permission: 'Visualizar [Cms] Depoimentos')) {
            return true;
        }
    }
    ...
    {
        if ($user->hasPermissionTo(permission: 'Cadastrar [Cms] Depoimentos')) {
            return true;
        }
    }
    ...
    {
        if ($user->hasPermissionTo(permission: 'Editar [Cms] Depoimentos')) {
            return true;
        }
    }
    ...
    {
        if ($user->hasPermissionTo(permission: 'Deletar [Cms] Depoimentos')) {
            return true;
        }
    }
