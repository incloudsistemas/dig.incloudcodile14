...
use App\Filament\Resources\Cms\ExternalUsefulLinkResource\Pages;
use App\Filament\Resources\Cms\ExternalUsefulLinkResource\RelationManagers;
...
class ExternalUsefulLinkResource extends Resource
{
    protected static ?string $model = ExternalUsefulLink::class;

    protected static ?string $recordTitleAttribute = 'title';

    protected static ?string $modelLabel = 'Link Externo';

    protected static ?string $pluralModelLabel = 'Links Externos';
    ...
    {
        return [
            'index' => Pages\ManageExternalUsefulLinks::route('/'),
        ];
    }
}
