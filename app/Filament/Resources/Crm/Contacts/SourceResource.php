...
use App\Filament\Resources\Crm\Contacts\SourceResource\Pages;
use App\Filament\Resources\Crm\Contacts\SourceResource\RelationManagers;
...
class SourceResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Origem do Contato';

    protected static ?string $pluralModelLabel = 'Origens dos Contatos';

    protected static ?string $navigationGroup = 'CRM';

    protected static ?int $navigationSort = 98;

    protected static ?string $navigationLabel = 'Origens dos Contatos';
